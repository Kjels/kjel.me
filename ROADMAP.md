...
- [x] **LinkedIn** beside EMAIL and GITHUB in the about section
...
- [x] **Content layer.** Layout with masthead, MDX, `/work` with GitHub roadmap progress, `/work/[slug]`, `/about`
- [x] **Writing.** A post is HTML under the masthead: stated measure on the board's own pitch, a rail, notes that open in the measure, the glider to close. Both indexes are boards. The whole surface stays hidden until the first post
